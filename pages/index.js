    ...
    <div className='bg-primary/60 h-full'>
      ...
      <div className='w-full h-full bg-gradient-to-r from-primary/10 via-black/30'>
        <div className='text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full
          ...
          <motion.div variants={fadeIn('down', 0.4)} initial='hidden' animate='show' exit='hidden'className='hidden xl:flex  mb-[40px]'>
            <ProjectsBtn />
          </motion.div>
        </div>
      </div>
      ...
      <div className='w-[1200px] h-full absolute right-0 bottom-0'>
        ...
        <motion.div variants={fadeIn('up', 0.5)} initial='hidden' animate='show'
          exit='hidden' transition={{ duration: 1, ease: 'easeInOut' }}
          className='w-full h-full max-w-[500px] max-h-[450px] 
            absolute -bottom-35 lg:bottom-0 lg:right-[8%]'>
          <Avatar />
        </motion.div>
      </div>
    </div>
